...
const AboutHomiq = () => {
  ...
  return (
    <div
      className={`flex gap-14 pt-20 md:px-15 px-5 transition-colors duration-300 ${
        darkMode ? 'bg-gray-900' : 'bg-[#F5F5F5]'
      }`}
    >
      <div className='relative md:h-143  hidden md:block'>
        <div
          className={`w-43 h-63 absolute left-25 flex flex-col items-center transition-colors duration-300 ${
        ...
        >
          ...
          <span
            className={`text-7xl text-center mt-4 transition-colors duration-300 ${
        ...
        <div
          className={`w-128 h-21 absolute md:left-24.5 left-10 -bottom-1 flex gap-8 px-8 items-center text-center transition-colors duration-300 ${
        ...
        <img loading='lazy' src={aboutUs} alt='room' className='mt-24 h-119 w-152' />
      </div>

      <div>
        <span
          className={`uppercase w-30 h-10 text-center text-sm pt-3 inline-block md:mt-33 font-semibold transition-colors duration-300 ${
        ...
        <h2
          className={`text-2xl md:text-5xl md:w-132 w-56 mt-4 transition-colors duration-300 ${
            darkMode ? 'text-white' : 'text-[#054457]'
          }`}
        >
        ...
        <p
          className={`text-sm md:text-lg md:w-126 w-60 mt-4 transition-colors duration-300 ${
